...
app.post('/api/marathon-fire-and-forget', async (c) => {
  ...
  await insertData(firstName, lastName, email, address, distance, c.env.DATABASE_URL).catch(console.error)
...
async function insertData(firstName: string, lastName: string, email: string, address:string, distance:Distance, apikey_db: string) {
